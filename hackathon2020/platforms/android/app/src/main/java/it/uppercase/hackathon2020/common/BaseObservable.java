package it.uppercase.hackathon2020.common;
...
public abstract class BaseObservable<LISTENER_CLASS> {
        ...
        synchronized (MONITOR) {
            ...
            if (!mListeners.contains(listener)) {
                ...
                if (hadNoListeners && mListeners.size() == 1) {
                    onFirstListenerRegistered(listener.getClass().getSimpleName());
                }
            }
        }
    }
    ...
    protected void onFirstListenerRegistered(String name) {
    }
